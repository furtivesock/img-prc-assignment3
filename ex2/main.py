...
def get_relevant_matches(frag_img, matches, img_keypoints, frag_keypoints, n=MATCHES_N, max_i=MAX_ITER, threshold_radius=THRESHOLD_RADIUS):
    ...
    for i in range(max_i):
        ...
        center_img = get_translated_coordinates(t, center_frag)
...
def get_translated_coordinates(pt, t):
    return (t[0] + pt[0], t[1] + pt[1])
...
# TODO: Question 3
def get_model_regression(inliers_matches):
    pass
